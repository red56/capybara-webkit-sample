...
RSpec.describe ThingsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created thing" do
        post :create, {:thing => valid_attributes}, valid_session
        expect(response).to redirect_to(Thing.last)
      end
    end

    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:thing => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested thing" do
        thing = Thing.create! valid_attributes
        put :update, {:id => thing.to_param, :thing => new_attributes}, valid_session
        thing.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        thing = Thing.create! valid_attributes
        put :update, {:id => thing.to_param, :thing => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the things list" do
      thing = Thing.create! valid_attributes
      delete :destroy, {:id => thing.to_param}, valid_session
      expect(response).to redirect_to(things_url)
    end
  end
